...
public interface INode {
  ...
  /**
   * Returns the point of intersection of the given viewRay in this scenegraph
   * @param currentTransformationStack
   * @param viewRay
   * @param hit
   * @return
   */
  void intersect(Stack<Matrix4f> currentTransformationStack, Ray viewRay, HitRecord hit, Map<String, TextureImage> textureImages);
