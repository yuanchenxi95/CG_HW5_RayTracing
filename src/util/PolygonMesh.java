...
public class PolygonMesh {
  ...
  public List<Vector4f> getVertexPositionsAsList() {
    return new ArrayList<Vector4f>(positions);
  }
  ...
  public List<Vector4f> getVertexNormalsAsList() {
    return new ArrayList<Vector4f>(normals);
  }
  ...
  public List<Vector4f> getTexCoordsAsList() {
    return new ArrayList<Vector4f>(texcoords);
  }
  ...
  public List<Integer> getPrimitivesAsList() {
  ...
  public void setNormals(List<Vector4f> vn) {
    normals = new ArrayList<Vector4f>(vn);
  }

  public void setTexcoords(List<Vector4f> vt) {
    texcoords = new ArrayList<Vector4f>(vt);
  }
