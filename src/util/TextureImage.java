...
public class TextureImage
{
  ...
  public Vector4f getColor(float x,float y)
  {
    ...
    Vector4f inter1 = one.lerp(three,y*image.getHeight()-y1);
    Vector4f inter2 = two.lerp(four,y*image.getHeight()-y1);
    Vector4f inter3 = inter1.lerp(inter2,x*image.getWidth()-x1);
